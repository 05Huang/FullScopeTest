...
| **P25: 代码架构优化** | | | |
| P25-1 前端测试覆盖率提升到 40%+ | 🟡 | ✅ 完成 | 366cc05 |
...
| P28-4 存储服务 TODO 补全 | 2h | ✅ 完成 | (已有 OSSStorage + S3Storage) |
| P28-5 限流 TODO 补全 | 1h | ✅ 完成 | (TODO 已清除) |
| P28-6 ResponseViewer 暗色模式适配 | 15min | ✅ 完成 | 507749e |
| **P29: 用户体验小功能** | | | |
| P29-1 侧边栏折叠状态持久化 | 15min | ✅ 完成 | a006d9f |
| P29-2 面包屑导航 | 1h | ✅ 完成 | (PageBreadcrumb 已集成) |
| P29-3 404 页面 | 30min | ✅ 完成 | 832dd1d |
| P29-4 请求历史记录 | 1.5h | ✅ 完成 | (RequestHistory 已集成) |
| P29-5 多语言代码片段生成 | 1.5h | ✅ 完成 | (snippetGenerators 已集成) |
| P29-6 项目收藏/置顶 | 1h | ✅ 完成 | (is_pinned 字段已存在) |
| P29-7 版本号与环境标识显示 | 30min | ✅ 完成 | (v1.0.0 + Demo/Dev 标签) |
| P29-8 空状态插画 | 1h | ✅ 完成 | (EmptyState 组件已存在) |
| P29-9 回到顶部按钮 | 15min | ✅ 完成 | d082151 |
| P29-10 骨架屏加载状态 | 1h | ✅ 完成 | (Skeleton 已用于 Dashboard) |
| P29-11 测试分享链接 | 1h | ✅ 完成 | (Reports 复制链接已实现) |
| P29-12 环境变量自动补全 | 1.5h | ✅ 完成 | a00009e |
| P29-13 响应体搜索/过滤 | 30min | ✅ 完成 | (Monaco find + 格式化/复制) |
| P29-14 浏览器通知 | 1h | ✅ 完成 | (browserNotification.ts 已存在) |
| P29-15 会话超时预警 | 1h | ✅ 完成 | (SessionWarning 已集成) |
| **P30: 后端小功能** | | | |
| P30-1 cURL 导入增强 | 1h | ✅ 完成 | (支持 --data-raw/--data-binary/--compressed) |
| P30-2 响应时间分位数统计 | 1.5h | ✅ 完成 | (/reports/percentiles 已实现) |
| P30-3 用例搜索增强 | 1h | ✅ 完成 | (method/url_contains/tags/priority 筛选) |
| P30-4 重复请求防抖 | 15min | ✅ 完成 | (if (sending) return 防抖) |
| P30-5 测试执行进度条 | 1.5h | ✅ 完成 | 9ed6865 |
| P30-6 环境变量导入/导出 | 1h | ✅ 完成 | (export/import 端点已存在) |
| P30-7 API 响应对比 | 1.5h | ✅ 完成 | (ResponseDiff.tsx 已存在) |
| P30-8 全局错误页面 | 1h | ✅ 完成 | (ServerError.tsx + ErrorBoundary) |
| P30-9 登录页记住用户名 | 15min | ✅ 完成 | 5d8fe48 |
| P30-10 用例集树形折叠 | 1h | ✅ 完成 | (Collapse + expandedCollections 已实现) |
